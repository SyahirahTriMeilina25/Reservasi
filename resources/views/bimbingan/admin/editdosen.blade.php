...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="mb-2 gradient-text fw-bold">Edit Dosen</h1>
            <hr>
            ...
            <div class="card card-custom">
                <div class="card-body card-body-custom">
                    <h5 class="mb-4 fw-bold">Informasi Dosen</h5>
                    <hr class="mb-4">
                    
                    <form action="{{ route('admin.updatedosen', $dosen->nip) }}" method="POST" id="editDosenForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   maxlength="20">
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1"></i>Nomor Induk Pegawai
                            </div>
                            @error('nip')
                        ...
                        <div class="mb-4">
                            <label for="nama_singkat" class="form-label">
                                Nama Singkat <span class="required-asterisk">*</span>
                            </label>
                            <input type="text" 
                                   class="form-control @error('nama_singkat') is-invalid @enderror" 
                                   id="nama_singkat" 
                                   name="nama_singkat" 
                                   value="{{ old('nama_singkat', $dosen->nama_singkat) }}" 
                                   required
                                   placeholder="Contoh: Dr. Smith"
                                   maxlength="50">
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1"></i>Nama singkat untuk ditampilkan
                            </div>
                            @error('nama_singkat')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('role_id') is-invalid @enderror" 
                                ...
                                <option value="{{ $role->id }}" {{ old('role_id', $dosen->role_id) == $role->id ? 'selected' : '' }}>
                                    {{ ucfirst(str_replace('_', ' ', $role->role_akses)) }}
                                </option>
                                @endforeach
                            </select>
                            @error('role_id')
            ...
            <div class="card card-custom mt-4">
                ...
                <div class="card-body card-body-custom">
                    <div class="d-flex align-items-start mb-3">
                        ...
                        <div>
                            <p class="mb-2">Reset password dosen ke default (sama dengan NIP).</p>
                            <small class="text-muted">Password akan direset menjadi: <strong>{{ $dosen->nip }}</strong></small>
                        </div>
                    </div>
    ...
    function handleFormSubmit(form) {
        ...
        if (typeof Swal !== 'undefined') {
            Swal.fire({
                ...
                text: `Apakah Anda yakin ingin menyimpan perubahan data dosen "${nama}"?`,
                icon: 'question',
            ...
            if (confirm(`Apakah Anda yakin ingin menyimpan perubahan data dosen "${nama}"?`)) {
                submitFormData(form, submitBtn, submitBtnDesktop, nama);
            }
        }
    }
        ...
        .then(data => {
            if (data.success) {
                showSuccessAlert(
                    ...
                    data.message || `Data dosen "${nama}" berhasil diperbarui.`,
                    function() {
                        // Redirect or reload
                        if (data.redirect) {
