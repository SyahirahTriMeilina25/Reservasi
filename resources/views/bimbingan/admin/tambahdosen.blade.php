...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="mb-2 gradient-text fw-bold">Tambah Dosen</h1>
            <hr>
            ...
            <div class="card card-custom">
                <div class="card-body card-body-custom">
                    ...
                    <form action="{{ route('admin.simpandosen') }}" method="POST" id="tambahDosenForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   placeholder="Contoh: Dr. Smith, M.Kom"
                                   maxlength="50"
                                   autocomplete="off">
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1"></i>Nama singkat untuk ditampilkan (dengan gelar)
                            </div>
                            @error('nama_singkat')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1"></i>Pilih jabatan sesuai dengan posisi dosen
                            </div>
                            @error('role_id')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1"></i>Minimum 6 karakter. Rekomendasi: gunakan NIP sebagai password awal
                            </div>
                            @error('password')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle me-1"></i>{{ $message }}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tambahForm = document.getElementById('tambahDosenForm');
    if (tambahForm) {
    ...
    // Auto-fill password based on NIP
...
function handleFormSubmit(form) {
    ...
    if (typeof Swal !== 'undefined') {
        Swal.fire({
            ...
            text: `Apakah Anda yakin ingin menyimpan data dosen "${nama}"?`,
            icon: 'question',
        ...
        if (confirm(`Apakah Anda yakin ingin menyimpan data dosen "${nama}"?`)) {
            submitFormData(form, submitBtn, submitBtnDesktop, nama);
        }
    }
}
    ...
    .then(data => {
        if (data.success) {
            showSuccessAlert(
                ...
                data.message || `Data dosen "${nama}" berhasil ditambahkan.`,
                function() {
                    // Redirect or reload
                    if (data.redirect) {
                        window.location.href = data.redirect;
                    } else {
                        // Redirect to data dosen page
                        window.location.href = '{{ route("admin.datadosen") }}';
                    }
                }
            );
        } else {
